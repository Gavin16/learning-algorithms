...
public class Day054 {
     ...
     * 分差最小??
     *
     * 定义dp1[i] 代表爱丽丝第i次操作后的得分
     * 定义dp2[i] 代表鲍勃第i次操作后的得分
     *
     * dp1[0] = 0, dp2[0] = 0
     * dp1[i] = dp1[i-1] + Math.max(dp2[i-1] - stones[s], dp2[i-1] - stones[t] )
     * dp2[i] = dp2[i-1] + Math.max(dp1[i-1] - stones[s], dp1[i-1] - stones[t])
     *
     */
